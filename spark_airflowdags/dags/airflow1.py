...
push_mongo_task = BashOperator(
    ...
    bash_command='/usr/local/spark/bin/spark-submit --master yarn --deploy-mode client --packages org.mongodb.spark:mongo-spark-connector_2.12:3.0.0 /home/ubuntu/csv_push_mongo/mongo.py',  # 파이썬 >실행
    dag=dag,
)
